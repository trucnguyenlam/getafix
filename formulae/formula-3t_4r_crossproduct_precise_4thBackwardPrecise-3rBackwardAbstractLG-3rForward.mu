...
#timer go;
/**
 * Compute 4th round backward precisely
 * Compute first three rounds backward with abstraction of Locals and Globals
 * Compute first three rounds forward with intersection with the configuration at the end of each round
 */
...
( false
  ...
  | (exists
        ...
        Global  t_G.
        (
          Thread1_2_backward(s_pc1, t_CL1, s_pc2, t_CL2, s_pc3, t_CL3, t_G)
          & t_G.v1 = 0
        )
        & ContextSwitch_1(s_pc1)
        & ContextSwitch_3(s_pc3)
...
//*********************************************************************************/
  ...
  |  (
      ...
      & (exists                  // There exists an internal state that
           ...
           Global  t_G.
           (    (
                  Thread3_1_backward( s_pc1, s_CL1, s_pc2, s_CL2, t_pc3, t_CL3, t_G )
                )
               // &( t_G.v1=0 | ( t_G.v1=1 & t_CL3.v0=1 ) )   // Start, so when it ends?
               &(
                  ( programInt1_3(s_pc3, t_pc3, s_CL3, t_CL3, s_G, t_G)      // Assignment related
  ...
  | (
       ...
       & (exists PrCount t_pc3.
             (
                Thread3_1_backward( s_pc1, s_CL1, s_pc2, s_CL2, t_pc3, s_CL3, s_G )
                 & programInt2_3(s_pc3, t_pc3, s_CL3, s_G)    // Control flow statement
             )
         )
    )
...
( false
  ...
  |  ( exists
          ...
          Global  t_G.
        (
          Thread3_1_backward( s_pc1, t_CL1, s_pc2, t_CL2, s_pc3, t_CL3, t_G )
          &  t_G.v1 = 0
        )
        &  ContextSwitch_2(s_pc2)
        &  ContextSwitch_3(s_pc3)
...
//*********************************************************************************/
  ...
  |  (
      ...
      & (exists                  // There exists an internal state that
           ...
           Local   t_CL2,
           Global  t_G.
           (    (   Thread2_1_backward( s_pc1, s_CL1, t_pc2, t_CL2,s_pc3, s_CL3, t_G )
                )
               // &( t_G.v1=0 | ( t_G.v1=1 & t_CL2.v0=1 ) )   // Start, so when it ends?
               &(
                  ( programInt1_2(s_pc2, t_pc2, s_CL2, t_CL2, s_G, t_G)      // Assignment related
  ...
  | (
       ...
       // & (s_G.v1=0 | ( s_G.v1=1 & s_CL2.v0=1 ) )     // Atomic condition
       & (exists PrCount t_pc2.
             (     Thread2_1_backward( s_pc1, s_CL1, t_pc2, s_CL2,s_pc3, s_CL3, s_G )
                 & programInt2_2(s_pc2, t_pc2,s_CL2,s_G)    // Control flow statement
             )
         )
    )
...
( false
  ...
  |  (exists
          ...
          Global  t_G.
        (
          Thread2_1_backward( s_pc1, t_CL1, s_pc2, t_CL2, s_pc3, t_CL3, t_G )
          &  t_G.v1 = 0
        )
        &  ContextSwitch_1(s_pc1)
        &  ContextSwitch_2(s_pc2)
...
//*********************************************************************************/
  ...
  |  (
      ...
      & (exists                  // There exists an internal state that
           ...
           Local   t_CL1,
           Global t_G.
           (    (   Thread1_1_backward( t_pc1, t_CL1, s_pc2, s_CL2,s_pc3, s_CL3, t_G )
                )
               // &( t_G.v1=0 | ( t_G.v1=1 & t_CL1.v0=1 ) )   // Start, so when it ends?
               &(
                  ( programInt1_1(s_pc1, t_pc1, s_CL1, t_CL1, s_G, t_G)      // Assignment related
  ...
  | (
       ...
       // & (s_G.v1=0 | ( s_G.v1=1 & s_CL1.v0=1 ) )     // Atomic condition
       & (exists PrCount t_pc1.
             (     Thread1_1_backward( t_pc1, s_CL1, s_pc2, s_CL2,s_pc3, s_CL3, s_G )
                 & programInt2_1(s_pc1,t_pc1,s_CL1,s_G)    // Control flow statement
             )
         )
    )
...
( false
  ...
  | (exists
        ...
        Global  t_G.
        (
          Thread1_1_backward(s_pc1, t_CL1, s_pc2, t_CL2, s_pc3, t_CL3, t_G)
          & t_G.v1 = 0
        )
        & ContextSwitch_1(s_pc1)
        & ContextSwitch_3(s_pc3)
...
//*********************************************************************************/
  ...
  |  (
      ...
      & (exists                  // There exists an internal state that
           ...
           Global  t_G.
           (    (
                  Thread3_0_backward( s_pc1, s_CL1, s_pc2, s_CL2, t_pc3, t_CL3, t_G )
                )
               // &( t_G.v1=0 | ( t_G.v1=1 & t_CL3.v0=1 ) )   // Start, so when it ends?
               &(
                  ( programInt1_3(s_pc3, t_pc3, s_CL3, t_CL3, s_G, t_G)      // Assignment related
  ...
  | (
       ...
       & (exists PrCount t_pc3.
             (
                Thread3_0_backward( s_pc1, s_CL1, s_pc2, s_CL2, t_pc3, s_CL3, s_G )
                 & programInt2_3(s_pc3, t_pc3, s_CL3, s_G)    // Control flow statement
             )
         )
    )
...
( false
  ...
  |  ( exists
          ...
          Global  t_G.
        (
          Thread3_0_backward( s_pc1, t_CL1, s_pc2, t_CL2, s_pc3, t_CL3, t_G )
          &  t_G.v1 = 0
        )
        &  ContextSwitch_2(s_pc2)
        &  ContextSwitch_3(s_pc3)
...
//*********************************************************************************/
  ...
  |  (
      ...
      & (exists                  // There exists an internal state that
           ...
           Local   t_CL2,
           Global  t_G.
           (    (   Thread2_0_backward( s_pc1, s_CL1, t_pc2, t_CL2,s_pc3, s_CL3, t_G )
                )
               // &( t_G.v1=0 | ( t_G.v1=1 & t_CL2.v0=1 ) )   // Start, so when it ends?
               &(
                  ( programInt1_2(s_pc2, t_pc2, s_CL2, t_CL2, s_G, t_G)      // Assignment related
  ...
  | (
       ...
       // & (s_G.v1=0 | ( s_G.v1=1 & s_CL2.v0=1 ) )     // Atomic condition
       & (exists PrCount t_pc2.
             (     Thread2_0_backward( s_pc1, s_CL1, t_pc2, s_CL2,s_pc3, s_CL3, s_G )
                 & programInt2_2(s_pc2, t_pc2,s_CL2,s_G)    // Control flow statement
             )
         )
    )
...
( false
  ...
  |  (exists
          ...
          Global  t_G.
        (
          Thread2_0_backward( s_pc1, t_CL1, s_pc2, t_CL2, s_pc3, t_CL3, t_G )
          &  t_G.v1 = 0
        )
        &  ContextSwitch_1(s_pc1)
        &  ContextSwitch_2(s_pc2)
...
//*********************************************************************************/
  ...
  |  (
      ...
      & (exists                  // There exists an internal state that
           ...
           Local   t_CL1,
           Global t_G.
           (    (   Thread1_0_backward( t_pc1, t_CL1, s_pc2, s_CL2,s_pc3, s_CL3, t_G )
                )
               // &( t_G.v1=0 | ( t_G.v1=1 & t_CL1.v0=1 ) )   // Start, so when it ends?
               &(
                  ( programInt1_1(s_pc1, t_pc1, s_CL1, t_CL1, s_G, t_G)      // Assignment related
  ...
  | (
       ...
       // & (s_G.v1=0 | ( s_G.v1=1 & s_CL1.v0=1 ) )     // Atomic condition
       & (exists PrCount t_pc1.
             (     Thread1_0_backward( t_pc1, s_CL1, s_pc2, s_CL2,s_pc3, s_CL3, s_G )
                 & programInt2_1(s_pc1,t_pc1,s_CL1,s_G)    // Control flow statement
             )
         )
    )
...
( false
  ...
  |  (
         ...
         & Thread1_0_backward( s_pc1, s_CL1, s_pc2, s_CL2, s_pc3, s_CL3, s_G )
     )
...
( false
  ...
  |  (
        ...
        &  Thread2_0_backward( s_pc1, s_CL1, s_pc2, s_CL2, s_pc3, s_CL3, s_G )
        &  s_G.v1 = 0
        &  ContextSwitch_1(s_pc1)
     )
...
( false
  ...
  |  (
        ...
        &  Thread3_0_backward( s_pc1, s_CL1, s_pc2, s_CL2, s_pc3, s_CL3, s_G )
        &  s_G.v1 = 0
        &  ContextSwitch_2(s_pc2)
     )
...
( false
  ...
  |  (
        ...
        &  Thread1_1_backward( s_pc1, s_CL1, s_pc2, s_CL2, s_pc3, s_CL3, s_G )
        &  s_G.v1 = 0
        &  ContextSwitch_3(s_pc3)
     )
...
( false
  ...
  |  (
        ...
        &  Thread2_1_backward( s_pc1, s_CL1, s_pc2, s_CL2, s_pc3, s_CL3, s_G )
        &  s_G.v1 = 0
        &  ContextSwitch_1(s_pc1)
     )
...
( false
  ...
  |  (
        ...
        &  Thread3_1_backward( s_pc1, s_CL1, s_pc2, s_CL2, s_pc3, s_CL3, s_G )
        &  s_G.v1 = 0
        &  ContextSwitch_2(s_pc2)
     )
...
( false
  ...
  |  (
        ...
        &  Thread2_2_backward(s_pc1, s_CL1, s_pc2, s_CL2,s_pc3, s_CL3, s_G)
        &  s_G.v1 = 0
        &  ContextSwitch_1(s_pc1)
     )
...
( false
  ...
  |  (
        ...
        &  Thread3_2_backward(s_pc1, s_CL1, s_pc2, s_CL2,s_pc3, s_CL3, s_G)
        &  s_G.v1 = 0
        &  ContextSwitch_2(s_pc2)
     )
