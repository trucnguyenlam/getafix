...
(false
  | (exists
      Local  t_CL2,
      Local  t_CL3.
      Thread3_1( s_pc1, s_CL, s_pc2, t_CL2, s_pc3, t_CL3, s_G )
      & s_G.v1 = 0
      & ContextSwitch_1(s_pc1)
      & ContextSwitch_2(s_pc2)
      & ContextSwitch_3(s_pc3)
  ...
  | (exists
      Local  t_CL1,
      Local  t_CL3.
      Thread3_1( s_pc1, t_CL1, s_pc2, s_CL, s_pc3, t_CL3, s_G )
      & s_G.v1 = 0
      & ContextSwitch_1(s_pc1)
      & ContextSwitch_2(s_pc2)
      & ContextSwitch_3(s_pc3)
  ...
  | (exists
      Local  t_CL1,
      Local  t_CL2.
      Thread3_1( s_pc1, t_CL1, s_pc2, t_CL2, s_pc3, s_CL, s_G )
      & s_G.v1 = 0
      & ContextSwitch_1(s_pc1)
      & ContextSwitch_2(s_pc2)
      & ContextSwitch_3(s_pc3)
...
(false
  | (exists
      ...
      Local  t_CL2,
      Local  t_CL3.
      Thread3_1( s_pc1, t_CL1, s_pc2, t_CL2, s_pc3, t_CL3, s_G )
      & s_G.v1 = 0
      & ContextSwitch_1(s_pc1)
      & ContextSwitch_2(s_pc2)
      & ContextSwitch_3(s_pc3)
