...
( false
  ...
  | ( exists                   // There exists a state such that
            ...
            Local      t_CL3,
            Global    t_G.
        (   Thread1_0( 1, t_pc1, t_CL1, t_pc2, t_CL2, t_pc3, t_CL3, t_G )    // That state in fixed point and ...
...
( false
  ...
  | ( exists                   // There exists a state such that
            ...
            Local      t_CL3,
            Global    t_G.
        (   Thread2_0( 2, t_pc1, t_CL1, t_pc2, t_CL2, t_pc3, t_CL3, t_G )    // That state in fixed point and ...
  ...
  |  (
        ...
        &  Thread1_0( 1, s_pc1, s_CL1, s_pc2, s_CL2,s_pc3, s_CL3, s_G )
        &  thread = 2
        &  s_G.v1 = 0
...
( false
  ...
  | ( exists                   // There exists a state such that
            ...
            Local      t_CL3,
            Global    t_G.
        (   Thread3_0( 3, t_pc1, t_CL1, t_pc2, t_CL2, t_pc3, t_CL3, t_G )    // That state in fixed point and ...
  ...
  |  (
        ...
        &  Thread2_0( 2, s_pc1, s_CL1, s_pc2, s_CL2,s_pc3, s_CL3, s_G )
        &  thread = 3
        &  s_G.v1 = 0
...
(false
  | (exists
      Local  t_CL2,
      Local  t_CL3.
      Thread3_0( thread, s_pc1, s_CL, s_pc2, t_CL2, s_pc3, t_CL3, s_G )
      & thread = 1
    )
  | (exists
      Local  t_CL1,
      Local  t_CL3.
      Thread3_0( thread, s_pc1, t_CL1, s_pc2, s_CL, s_pc3, t_CL3, s_G )
      & thread = 2
    )
  | (exists
      Local  t_CL1,
      Local  t_CL2.
      Thread3_0( thread, s_pc1, t_CL1, s_pc2, t_CL2, s_pc3, s_CL, s_G )
      & thread = 3
    )
);
#size Round0_Core;
...
( false
  ...
  | ( exists                   // There exists a state such that
            ...
            Local      t_CL3,
            Global    t_G.
        (   Thread1_1( 1, t_pc1, t_CL1, t_pc2, t_CL2, t_pc3, t_CL3, t_G )    // That state in fixed point and ...
          &    target( 1, t_pc1 )                // target is reached
        )
     )
  ...
  // initial configuration (init)
  |  (
        Thread3_0( 3, s_pc1, s_CL1, s_pc2, s_CL2, s_pc3, s_CL3, s_G )
        &  thread = 1
        &  s_G.v1 = 0
...
( false
  ...
  | ( exists                   // There exists a state such that
            ...
            Local      t_CL3,
            Global    t_G.
        (   Thread2_1( 2, t_pc1, t_CL1, t_pc2, t_CL2, t_pc3, t_CL3, t_G )    // That state in fixed point and ...
          &    target( 2, t_pc2 )                // target is reached
        )
     )
  ...
  // initial configuration (init)
  |  (
        Thread1_1( 1, s_pc1, s_CL1, s_pc2, s_CL2,s_pc3, s_CL3, s_G )
        &  thread = 2
        &  s_G.v1 = 0
        &  ContextSwitch_1(s_pc1)
     )
...
( false
  ...
  | ( exists                   // There exists a state such that
            ...
            Local      t_CL3,
            Global    t_G.
        (   Thread3_1( 3, t_pc1, t_CL1, t_pc2, t_CL2, t_pc3, t_CL3, t_G )    // That state in fixed point and ...
          &    target( 3, t_pc3 )                // target is reached
        )
     )
  ...
  // initial configuration (init)
  |  (
        Thread2_1( 2, s_pc1, s_CL1, s_pc2, s_CL2,s_pc3, s_CL3, s_G )
        &  thread = 3
        &  s_G.v1 = 0
        &  ContextSwitch_2(s_pc2)
     )
...
( false
  ...
  | ( exists                   // There exists a state such that
            ...
            Local      t_CL3,
            Global    t_G.
        (   Thread1_2( 1, t_pc1, t_CL1, t_pc2, t_CL2, t_pc3, t_CL3, t_G )    // That state in fixed point and ...
          &    target( 1, t_pc1 )                // target is reached
        )
     )
  ...
  // initial configuration (init)
  |  (
        Thread3_1( 3, s_pc1, s_CL1, s_pc2, s_CL2,s_pc3, s_CL3, s_G )
        &  thread = 1
        &  s_G.v1 = 0
        &  ContextSwitch_3(s_pc3)
     )
...
( false
  ...
  | ( exists                   // There exists a state such that
            ...
            Local      t_CL3,
            Global     t_G.
        (   Thread2_2( 2, t_pc1, t_CL1, t_pc2, t_CL2, t_pc3, t_CL3, t_G )    // That state in fixed point and ...
          &    target( 2, t_pc2 )                // target is reached
        )
     )
  ...
  // initial configuration (init)
  |  (
        Thread1_2( 1, s_pc1, s_CL1, s_pc2, s_CL2,s_pc3, s_CL3, s_G )
        &  thread = 2
        &  s_G.v1 = 0
        &  ContextSwitch_1(s_pc1)
     )
...
( false
  ...
  | ( exists                   // There exists a state such that
            ...
            Local      t_CL3,
            Global    t_G.
        (   Thread3_2( 3, t_pc1, t_CL1, t_pc2, t_CL2, t_pc3, t_CL3, t_G )    // That state in fixed point and ...
          &    target( 3, t_pc3 )                // target is reached
        )
     )
  ...
  // initial configuration (init)
  |  (
        Thread2_2( 2, s_pc1, s_CL1, s_pc2, s_CL2,s_pc3, s_CL3, s_G )
        &  thread = 3
        &  s_G.v1 = 0
        &  ContextSwitch_2(s_pc2)
     )
...
(false
  | (exists
      Local  t_CL2,
      Local  t_CL3.
      Thread3_2( thread, s_pc1, s_CL, s_pc2, t_CL2, s_pc3, t_CL3, s_G )
      & thread = 1
    )
  | (exists
      Local  t_CL1,
      Local  t_CL3.
      Thread3_2( thread, s_pc1, t_CL1, s_pc2, s_CL, s_pc3, t_CL3, s_G )
      & thread = 2
    )
  | (exists
      Local  t_CL1,
      Local  t_CL2.
      Thread3_2( thread, s_pc1, t_CL1, s_pc2, t_CL2, s_pc3, s_CL, s_G )
      & thread = 3
    )
);
#size Round2_Core;
...
( false
  ...
  | ( exists                   // There exists a state such that
            ...
            Local      t_CL3,
            Global    t_G.
        (   Thread1_3( 1, t_pc1, t_CL1, t_pc2, t_CL2, t_pc3, t_CL3, t_G )    // That state in fixed point and ...
          &    target( 1, t_pc1 )                // target is reached
        )
     )
  ...
  // initial configuration (init)
  |  (
        Thread3_2( 3, s_pc1, s_CL1, s_pc2, s_CL2, s_pc3, s_CL3, s_G )
        &  thread = 1
        &  s_G.v1 = 0
        &  ContextSwitch_3(s_pc3)
     )
...
( false
  ...
  | ( exists                   // There exists a state such that
            ...
            Local      t_CL3,
            Global    t_G.
        (   Thread2_3( 2, t_pc1, t_CL1, t_pc2, t_CL2, t_pc3, t_CL3, t_G )    // That state in fixed point and ...
          &    target( 2, t_pc2 )                // target is reached
        )
     )
...
( false
  ...
  | ( exists                   // There exists a state such that
            ...
            Local      t_CL3,
            Global    t_G.
        (   Thread3_3( 3, t_pc1, t_CL1, t_pc2, t_CL2, t_pc3, t_CL3, t_G )    // That state in fixed point and ...
          &    target( 3, t_pc3 )                // target is reached
        )
     )
  ...
  | (
      (
        exists
            ...
            PrCount    t_pc2,
            Local      t_CL2.
        Thread2_3( 2, t_pc1, t_CL1, t_pc2, t_CL2, s_pc3, s_CL3, s_G )
      )
      &  thread = 3
      &  s_G.v1 = 0
      &  ContextSwitch_2(s_pc2)
...
(false
  | (exists
      Local  t_CL2,
      Local  t_CL3.
      Thread3_3( thread, s_pc1, s_CL, s_pc2, t_CL2, s_pc3, t_CL3, s_G )
      & thread = 1
    )
  | (exists
      Local  t_CL1,
      Local  t_CL3.
      Thread3_3( thread, s_pc1, t_CL1, s_pc2, s_CL, s_pc3, t_CL3, s_G )
      & thread = 2
    )
  | (exists
      Local  t_CL1,
      Local  t_CL2.
      Thread3_3( thread, s_pc1, t_CL1, s_pc2, t_CL2, s_pc3, s_CL, s_G )
      & thread = 3
    )
);
#size Round3_Core;
