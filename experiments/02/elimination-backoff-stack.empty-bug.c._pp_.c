...
# 1 "<command-line>" 2
# 1 "<stdin>"
# 1 "/home/trucnguyenlam/Development/benchmarks/03.Jad-popl15/001.elimstack/benchs/elimination-backoff-stack.empty-bug.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 1 "<command-line>" 2
...
# 2 "./preprocessor/ccpp-0.1/fake_include/stdlib.h" 2
# 2 "/home/trucnguyenlam/Development/benchmarks/03.Jad-popl15/001.elimstack/benchs/elimination-backoff-stack.empty-bug.c" 2
# 1 "./preprocessor/ccpp-0.1/fake_include/stdio.h" 1
# 3 "/home/trucnguyenlam/Development/benchmarks/03.Jad-popl15/001.elimstack/benchs/elimination-backoff-stack.empty-bug.c" 2
# 1 "./preprocessor/ccpp-0.1/fake_include/pthread.h" 1
# 4 "/home/trucnguyenlam/Development/benchmarks/03.Jad-popl15/001.elimstack/benchs/elimination-backoff-stack.empty-bug.c" 2
# 26 "/home/trucnguyenlam/Development/benchmarks/03.Jad-popl15/001.elimstack/benchs/elimination-backoff-stack.empty-bug.c"
...
# 89 "/home/trucnguyenlam/Development/benchmarks/03.Jad-popl15/001.elimstack/benchs/elimination-backoff-stack.empty-bug.c"
...
int TryPerformStackOp(ThreadInfo* p) {
    ...
    if (p->op == 0) {
        ...
        if (__VERIFIER_atomicc_cas(&S.ptop,thead,tnext)) {
            ...
            p->cell = *thead;
# 158 "/home/trucnguyenlam/Development/benchmarks/03.Jad-popl15/001.elimstack/benchs/elimination-backoff-stack.empty-bug.c"
            return 1;
        }
        else {
...
# 216 "/home/trucnguyenlam/Development/benchmarks/03.Jad-popl15/001.elimstack/benchs/elimination-backoff-stack.empty-bug.c"
void Push(int x) {
