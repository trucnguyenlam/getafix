/*  Generated 0.0.0.0.0.0 (-t7 -r2 -u1 -bcbmc) 2016-04-15 09:11:23  */
#include <stdint.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
tinstrPop3_0_8: IF(4, 8, tinstrPop3_0_9)                 if (MEM_VALUE[n_pop_t0] == 0)
    {
...
tinstrPop4_0_8: IF(5, 8, tinstrPop4_0_9)                 if (MEM_VALUE[n_pop_t1] == 0)
    {
...
tinstrPop5_0_8: IF(6, 8, tinstrPop5_0_9)                 if (MEM_VALUE[n_pop_t2] == 0)
    {
...
tinstrPop6_0_8: IF(7, 8, tinstrPop6_0_9)                 if (MEM_VALUE[n_pop_t3] == 0)
    {
